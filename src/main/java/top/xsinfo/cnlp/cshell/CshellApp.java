 ...
 * 具体功能可以查看文档
 */
public class CshellApp extends JcqAppAbstract implements ICQVer, IMsg, IRequest {
...
//        demo.privateMsg(0, 10003, 2111111334L, "可以给我你的私人微信吗", 0);
//        demo.privateMsg(0, 10004, 3111111114L, "翻译成英语", 0);
//        demo.privateMsg(0, 10005, 3111111114L, "你是谁", 0);
//        demo.privateMsg(0, 10005, 3111111114L, "你好吗", 0);
//        demo.privateMsg(0, 10005, 3111111114L, "翻译成韩语", 0);
//        demo.privateMsg(0, 10005, 3111111114L, "过年好", 0);
//        demo.privateMsg(0, 10005, 3111111114L, "你好吗", 0);
//        demo.privateMsg(0, 10005, 3111111114L, "聊天模式", 0);
//        demo.privateMsg(0, 10005, 3111111114L, "展示", 0);
//        demo.privateMsg(0, 10006, 3111111114L, "交互式模式", 0);
//        demo.privateMsg(0, 10007, 3111111114L, "吾之名乃小帅也", 0);
//        demo.privateMsg(0, 10007, 3111111114L, "吾之芳龄乃18也", 0);
//        demo.privateMsg(0, 10007, 3111111114L, "吾有一术名曰展示 宣名 芳龄 是也", 0);
//        demo.privateMsg(0, 10007, 3111111114L, "吾之名", 0);
//        demo.privateMsg(0, 10007, 3111111114L, "吾之芳龄", 0);
        // 模拟群聊消息
        // 开始模拟群聊消息
...
//        demo.groupMsg(0, 10011, 427984429L, 11111111114L, "", "qwq 有没有一起开的\n[CQ:at,qq=3333333334]你玩嘛", 0);
    ...
    public String appInfo() {
        ...
        String AppID = "top.xsinfo.cnlp.cshell";// 记住编译后的文件和json也要使用appid做文件名
        /**
    ...
    public int startup() {
        Core.setLog(new Log() {
            ...
            public void logE(String title, String message) {
                CQ.logError(title,message);
            }

            @Override
            public void logI(String title, String message) {
                CQ.logInfo(title,message);
            }
        });
    ...
    public int privateMsg(int subType, int msgId, long fromQQ, String msg, int font) {
        Core.mappingMsg(fromQQ, msg, new MessageSend() {
            @Override
    ...
    public int friendAdd(int subtype, int sendTime, long fromQQ) {
        // 这里处理消息
        CQ.sendPrivateMsg(fromQQ,"你好,我叫小多啦");
